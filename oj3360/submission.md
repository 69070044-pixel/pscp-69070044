...
```text
รับ input เป็นความกว้างยาวและพิกัดที่จะเป็นเส้นตัดและให้หาชิ้นที่มีภพื้นที่มากที่สุดสองอัน
```
...
```text
Step 1: input ค่าความกว้างและยาวและจำนวนพิกัดในแกน x, y
Step 2: รับค่าพิกัดที่จะต้องตัด
Step 3: ใช้ for loop เพื่อที่จะหาพื้นที่ของแต่ละชิ้นเพื่อเก็บลงใน list
Step 4: นำ list ไป sort เรียงจากมากไปน้อย และแสดงผลตัวที่ 1 และ 2
```
...
```text
เหมือนแผนแรกใช้ loop เพื่อคำนวนหา area จากพิกัดที่มีและแสดงผล
```
