...
```text
ให้ใช้ * สร้างกรอบสี่เหลี่ยมให้กับข้อความที่รับเข้ามาจำนวน 5 บรรทัด
```
...
```text
Step 1: รับ input ไปเก็บใน list และหาความยาวของข้อความที่ยาวที่สุด
Step 2: นำความยาวที่มากที่สุดมาบวก 4 เพื่อเพื่มระยะให้พอดีกับกรอบด้านข้างทั้งสองด้าน และใช้แสดงผล * ตามจำนวนที่ได้เพื่อทำกรอบบนและล่าง
Step 3: loop เพื่อแสดงผลทีละบรรทัดโดยมี "* ", " *" ที่ด้านหน้าและหลังข้อความเพื่อให้วาดออกมาเป็นกรอบ
```
...
```text
เหมือนแผนแรกเมื่อ input หาข้อความที่ยาวที่สุดและนำไปใช้ในการแสดงผลตาราง
```
