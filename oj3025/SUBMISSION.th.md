...
Step 3:ถ้าหาร 3 ลงตัววันที่เกิน 21 หรือไม่
Step 4:ถ้าใช่ให้เพิ่มเดือนไป 1 เดือน
...
ตัวอย่าง
if month in [1, 2, 3, 13]: 13 คือเดือนที่ 13 จะเกิดขึ้นได้จากเดือนที่รับค่ามาคือ 12 และวันที่เกิน 21 จะถูก +1
    print("winter")
