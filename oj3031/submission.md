...
```text
input คือ อัตราการขยายของพื้นที่ต่อวินาทีและพิกัดของจุดที่จะไปถึง
output คือ ระยะเวลาที่จะขยายไปถึงในหน่วยวินาที
โดยที่ค่า pi = 3.1416
```
...
```text
Step 1: รับ input ค่า S, และ พิกัดทั้งหมด
Step 2: กำหนดค่า pi = 3.1416
Step 3: หาระยะจาก (0, 0) ถึง (x, y) ด้วยวิธีจากข้อ EuclideanDistance2D ซึ่งจะได้ระยะทางที่มีค่าเท่ากับรัศมีของวงกลมเมื่อถึงจุด (x, y)
Step 4: หาพื้นที่ของวงกลมด้วย pi * r ** 2 และนำไปหารกับอัตราการขยายของพื้นที่จะได้เวลาออกมา
Step 5: นำไปแสดงผลปัดเศษขึ้นเมื่อไม่ลงตัว
```
...
```text
เหมือนกับแผนแรกโดยเอาพิกัดมาคำนวนหารัศมีและใช้หาพื้อที่จากนั้นก็หารกับอัตราการขยายเพื่อหาเวลาที่ไปถึง
```
