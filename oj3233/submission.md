...
```text
รับค่ามา 2 ค่าคือ รางวัลที่ออกและที่น้อกระต่ายซื้อแล้วใหาว่ากระต่ายจะถูกรางวัลเท่าไหร่
```
...
```text
Step 1: รับ input และนำไปแยกเป็น list ด้วย split
Step 2: นำข้อมูลที่มีไปใช้หาว่าเข้าเกับเงื่อนไขใดและแสดงผลจำนวนรางวันที่ได้ตามที่กำหนด
```
...
```text
เหมือนแผนแรกเมื่อ input แปลง string แยกอักษรกับเลข และใช้ if else เพื่อตรวจเงื่อนไขจากนั้นก็ print
```
