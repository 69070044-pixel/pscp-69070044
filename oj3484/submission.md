...
```text
OJ3484 - [LEARNING LOGS] หุ่นยนต์เคาะเสียงกระเบื้อง
```
...
```text
input is size of tile and price per point and next in line = 2-n info about each point
output is table of tile data with number of not perfect tile and point
finally is total price of not perfect point
```
...
```text
Step 1: รับ input size and price
Step 2: loop for input tile data
Step 3: calculate data in row and column add data to list
Step 4: calculate sum
Step 5: print data and price
```
