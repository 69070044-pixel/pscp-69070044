...
```text
input คือ ค่าอุณหภูมิตามด้วยหน่วยของอุณหภูมิที่รับเข้ามาและหน่วยที่ต้องการ
output ค่าอุณหภูมิที่ถูกแปลงแล้วโดยมีทศนิยม 2 ตำแหน่ง
```
...
Step 2:หาหน่วยหลักในการแปลงค่าเช่นแปลงเป็น องศาเซลเซียส °c
Step 3:ใช้หน่วยหลักแปลงเป็นค่าที่ต้องการ
Step 4:แสดงผลคำตอบ
```
...
```text
เหมือนกันกับวิธีแรกโดยคำนวนจากหน่าวที่รับมาแปลงเป็น องศาเซลเซียส °c และนำไปใช้หาคำตอบ
...
```text
ให้คำแนะนำว่าสามารถแปลงหน่วยเป็นเซลเซียสก่อนได้ค่อยนำไปคำนวน
```
