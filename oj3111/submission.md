...
```text
รับค่า Y, N คือ เป็นสมาชิกมั้ยและจำนวนสินค้าจากนั้นคือราคาสินค้าแต่ละชิ้น
และหาราคาที่ลดแล้วจากราคาทั้งหมดหากเข้าเงื่อนไข
```
...
```text
Step 1: รับค่าการเป็นสมาชิก
Step 2: รับค่าจำนวนรายการสินค้าและประกาศตัวแปร total
Step 3: ใช้ loop รับค่าราคาและนำไปบวกเก็บไว้ใน total จนครบจำนวน
Step 4:  ตรวจเงื่อนไขคำนวนการลดราคาและแสดงผล
```
...
```text
คล้ายๆกับแผนแรกโดยมีการเพิ่ม function ที่ใช้ในการปัดเศษมาเพิ่มเนื่องจาก build-in function round() ไม่เหมาะจะใช้กับโจทย์นี้
```
