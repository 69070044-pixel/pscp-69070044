...
```text
รับค่าจำนวน brick ใหญ่และเล็กและค่า goal โดยต้องหาจำนวนก้อนเล็กที่จะต้องใช้น้อยที่สุดเมื่อต่อถึงระยะ goal
โดยที่ brick ใหญ่ = 5 นิ้วต่อก้อน, เล็ก = 1 นิ้วต่อก้อน และให้ใช้ก่อนใหญ่ให้หมดก่อนหรือถ้าก้อนใหญ่เกินระยะ goal
ให้เอาออกและใช้ก่อนเล็กแทนก็คือต้องต่อให้พอดีนั้นเอง
```
...
Step 2:หาระยะรวมทั้งหมดที่ต่อได้ว่ารวมกันมากกว่าหรือเท่ากับระยะ goal มั้ย
Step 3:คำนวนหาก้อนเล็กที่ต้องใช้
```
...
```text
Step 1: รับ input ทั้งหมด
Step 2: หาจำนวนก้อนให้ที่มาที่สุดที่ต้องใช้
Step 3.1: ถ้าจำนวนที่ต้องการก้อนใหญ่ที่ใช้มีพอ -> 4.1
Step 4.1: เอาก้อนใหญ่แค่ที่ใช้ไป * 5 เพื่อหาระยะที่ต่อได้
Step 3.2: ถ้าก้อนใหญ่ใช้หมดแล้วไม่พอต้องต่อก้อนเล็กเพิ่ม -> 4.2
Step 4.2: เอาก้อนใหญ่ทั้งหมดใช้ไป * 5 เพื่อหาระยะที่ต่อได้
Step 5.1: check ว่าก่อนเล็กมีพอมั้ยถ้าพอแสดงผลจำนวนก้อนที่ต้องใช้ ถ้าไม่พอต่อไม่ได้แสดง -1
```
