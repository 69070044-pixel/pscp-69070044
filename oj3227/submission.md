...
```text
รับค่าเป็น string บรรทัดเดียว คือชื่อย่อของไพ่และให้ print ออกมาเป็นชื่อเต็ม
```
...
```text
Step 1: รับ input และแยกค่ามาเก็บแต่ละส่วนโดยชื่อเต็มของด้านหลังจะเป็นตัวสุดท้ายดังนั้น จะเท่ากับ input[-1] และที่เหลือคือตัวย่อด้านหน้าหรือเลข input[:-1]
Step 2: สร้าง dict ที่เป็บตัวย่อเป็น key และชื่อเต็มเป็น value
Step 3: แสดงผลด้วย print
```
...
```text
เหมือนแผนแรกเมื่อ input มาแล้วแยกข้อมูลส่วนต่างๆ ออกและดึงชื่อเต็มมาจาก dict แล้วนำค่าไปแสดงผล
```
