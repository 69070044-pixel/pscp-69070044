...
```text
รับ input ตัวเลขเรื่อยจนกว่าค่าที่รับมาจะเป็น -1 และนำไปย่อและแสดงผลออกมาเป็นช่วงที่ต่อเนื่องกันโดยไม่ต้องเขียนเลขทุกตัว
โดยที่ค่าที่รับมาจะมีค่ามากขึ้นเสมอ
```
...
```text
Step 1: สร้างตัวแปรมาเพื่อใช้เก็บค่าตัวเลขทั้งหมดและค่าก่อนหน้า
Step 2: รับ input ด้วย while loop จนกว่าจะเจอ -1 ให้ break
Step 3: เก็บข้อมูลช่วงตัวเลขใน list ที่ซ้อนด้วย list อีกที
...
```text
เหมือนแผนแรกใช้ while loop รับ input เรื่อยๆจนออกลูปได้และแสดงผล
```
