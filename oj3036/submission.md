...
```text
input คือ ห้องเริ่มต้น
output คือ จำนวนกำแพงที่น้อยที่สุด
```
...
```text
Step 1: เมื่อดูจากรูปแล้วเลยคิดว่าอาจจะสร้างเป็น Dict ที่เอาเลขมาเชื่อมกันได้
Step 2: รับ input และนำไปทำงานต่อ
Step 3: โดยให้ลูปเปลี่ยนห้องพร้อมกับนับจำนวนครั้งจนกว่าค่าสุดท้ายที่ได้จาก Dict จะเป็น 1
Step 4: เมื่อออกจากลูปก็แสดงคำตอบ
```
...
```text
เนื่องจากกลับไปอ่านโจทย์ใหม่แล้วเห็นว่า Input สามารถมีค่าได้สูงสุดถึง 100000
จึงไปทำความเข้าใจโจทย์ใหม่และเปลี่ยนวิธี
โดยการหาแถวที่ n อยู่คือ root(n) และปัดขึ้นเมื่อมีเศษ
จากนั้นหาห้องแรกของแถวโดยหาตัวสุดท้ายของแถวบนคือ แถวที่คำนวนได้ก่อนหน้า - 1 และนำไปยกกำลัง
และหาความห่างของห้องแรกกับห้อง n ในแถวและนำไปเข้าเงื่อนไขว่าเป็นเลขคู่หรือคี่
และแสดงผลซึ่ง
ห่างกันเป็นเลขคี่หมายความว่าห้องที่ n เป็นสามเหลี่ยมแบบกลับหัว (ทำลาย 1 กำแพงไปชั้นถัดไปได้) คำตอบคือ (2 * (row - 1)) - 1
ห่างกันเป็นเลขคู่หมายความว่าห้องที่ n เป็นสามเหลี่ยมแบบปกติ (ทำลาย 2 กำแพงไปชั้นถัดไปได้) คำตอบคือ 2 * (row - 1)
```
