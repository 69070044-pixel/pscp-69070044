...
```text
รับ input วัตถุดิบ/ส่วนผสม จนจบการรับ
และให้บอกว่าผลที่ออกมาเป็นยังไง
```
...
```text
Step 1: สร้าง set ของวัตถุดิบ/ส่วนผสมทั้งหมด
Step 2: loop รับ input add to set for collect input
Step 3: compare inputset กับ setที่เตรียมไว้ เพื่อเปลี่ยนเป็น type boolean
Step 4: use if elif else เพื่อตรวจสอบเงื่อนไขและ print ตามที่กำหนดไว้
```
...
```text
เหมือนแผนแรกใช้ set ช่วยให้เปรียบเทียบ input กับ วัตถุดิบ/ส่วนผสมทั้งหมด
และใช้เพื่อเป็น condition สำหรับ if else และ print ตามที่โจทย์กำหนด
```
