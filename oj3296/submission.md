...
```text
รับค่าสีมา 2 สีโดยแต่ละสีจะมี 3 ค่า คือ R G B
โดยจะต้องนำค่าสีของทั้งสองสีมาผสมกัน
```
...
```text
Step 1: สร้าง function ที่ใช้เพื่อผสมแม่สีสองค่าเช่น R1 ผสมกับ R2
Step 2: สร้าง function ที่ใช้ผสมค่าสี RGB โดยใช้ function ผสมแม่สีผสมสี R G B ของทั้งสองสีเข้าด้วยกัน
Step 3: รับค่าสีทั้งสองมาและแสดงผลค่าที่ return มาจาก function ผสมสี RGB
```
...
```text
เหมือนแผนแรกนำ Input ไปแปลงเป็น list และนำไปคำนวนต่อใน function ที่เตรียมไว้
```
