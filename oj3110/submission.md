...
```text
รับค่าเส้นทางเริ่มต้นและจุดสุดท้ายและน้ำหนักเพื่อมาคำนวนหาค่าธรรมเนียมทั้งหมด
และแสดงผลหากไม่มีเส้่นทางแสดง Error
```
...
```text
Step 1: สร้าง dict ที่เก็บค่าธรรมเนียมของแต่ละเส้นทาง
Step 2: รับค่าโดยแปลง format ให้ตรงกับ key ของ dict
Step 3: รับค่าน้ำหนักของที่จะส่ง
Step 4: คำนวนหาค่าธรรมเนียมตาม rate ที่ได้ ถ้า key ไม่ถูกต้องให้แสดง Error
```
...
```text
เหมือนแผนแรกสร้าง dict ที่เก็บข้อมูลของแต่ละเส้นทางไว้และใช้ key ในการเข้าถึงค่าเพื่อนำมาคำนวนต่อ
```
