...
```text
OJ3381 - [LEARNING LOGS] Point Sorting
```
...
```text
รับค่าพิกัดต่างของชุดทดสอบแต่ละชุดตามจำนวนครั้งที่ใส่มาและให้นำไป sort โดยนำ x + y และให้เรียงจากน้อยไปมาก
```
...
```text
Step 1: input จำนวนชุดทดสอบและทุกๆ ชุดทดสอบจะรับจำนวนคู่อันดับ x, y
Step 2: รับค่า x, y เก็บให้ครบตามจำนวนในชุดทดสอบและทำการ sort ตามที่โจทย์ต้องการ
Step 3: เก็บค่า list ที่ sort แล้วลงใน list result
Step 4: นำ list result ไปแสดงผล
```
...
```text
เหมือนแผนแรกใช้ loop รับค่าและ sort list ให้ได้ตามที่ต้องการเก็บลงใน list หลักและแสดงผลเมื่อจบการรับค่าแล้ว
```
